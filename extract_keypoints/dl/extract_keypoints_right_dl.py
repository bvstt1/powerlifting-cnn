...
# Landmarks visibles desde vista derecha del DL
# (coincide con display: hombro + cadera)
SELECTED_IDXS = [
    12,  # hombro derecho
    24,  # cadera derecha
]
...
# -----------------------------------
# Procesar deadlift derecha
# -----------------------------------

def process_dl_right():

    input_dir = DATASET_ROOT / "dl" / "right"

    output_dir = OUTPUT_ROOT / "dl" / "right"
